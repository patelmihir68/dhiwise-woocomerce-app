...
import 'package:patel_s_application2/data/models/id/put_id_req.dart';

class EditProductScreen extends GetWidget<EditProductController> {
  @override
                            ...
                            children: [
                              ...
                              Align(
                                  ...
                                  child: Padding(
                                      ...
                                      child: Text("msg_edit_product_de".tr,
                              ...
                              Align(
                                  ...
                                  child: Padding(
                                      padding: EdgeInsets.only(
                                          ...
                                          right: getHorizontalSize(20.00)),
                                      child: Obx(() => Text(
                                          controller.editProductModelObj.value
                                              .titleTxt.value,
                                          overflow: TextOverflow.ellipsis,
                                          textAlign: TextAlign.left,
                                          style: AppStyle
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          focusNode: FocusNode(),
                                          controller:
                                              controller.group90Controller.value,
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          focusNode: FocusNode(),
                                          controller:
                                              controller.group90Controller1.value,
                                          decoration: InputDecoration(
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          focusNode: FocusNode(),
                                          controller:
                                              controller.group90Controller2.value,
                                          decoration: InputDecoration(
                              ...
                              Padding(
                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          focusNode: FocusNode(),
                                          controller:
                                              controller.group90Controller3.value,
                                          decoration: InputDecoration(
                              ...
                              Padding(
                                  ...
                                  child: GestureDetector(
                                      ...
                                      child: Container(
                                          ...
                                          child: Text("lbl_edit_product".tr,
                                              textAlign: TextAlign.left,
                                              style: AppStyle
                                                  .textstylepoppinssemibold16
                                                  .copyWith(
  ...
  void onTapBtnEditproduct() {
    PutIdReq putIdReq = PutIdReq(
      name: controller.group90Controller.value.text,
      shortDescription: controller.group90Controller1.value.text,
      regularPrice: controller.group90Controller2.value.text,
      salePrice: controller.group90Controller3.value.text,
      price: controller.group90Controller4.value.text,
    );
    controller.callUpdateId(
      putIdReq.toJson(),
      successCall: _onUpdateIdSuccess,
      errCall: _onUpdateIdError,
    );
  }

  void _onUpdateIdSuccess() {}
  void _onUpdateIdError() {}
}
